...
[![Build Status](https://travis-ci.org/bigcommerce/sprout-wrap.png?branch=master)](https://travis-ci.org/bigcommerce/sprout-wrap)
...
### 3. Clone this project
    ...
    git clone https://github.com/bigcommerce/sprout-wrap.git
    cd sprout-wrap
